...
import { PrismaClient, BrandStatus, ModelStatus } from '@prisma/client';

const prisma = new PrismaClient();

const popularEarbudsData = {
  brands: [
    { name: 'Apple', slug: 'apple', status: BrandStatus.SYSTEM },
    { name: 'Samsung', slug: 'samsung', status: BrandStatus.SYSTEM },
    { name: 'Sony', slug: 'sony', status: BrandStatus.SYSTEM },
    { name: 'Bose', slug: 'bose', status: BrandStatus.SYSTEM },
    { name: 'Sennheiser', slug: 'sennheiser', status: BrandStatus.SYSTEM },
    { name: 'JBL', slug: 'jbl', status: BrandStatus.SYSTEM },
    { name: 'Beats', slug: 'beats', status: BrandStatus.SYSTEM },
    { name: 'Audio-Technica', slug: 'audio-technica', status: BrandStatus.SYSTEM },
    { name: 'Jabra', slug: 'jabra', status: BrandStatus.SYSTEM },
    { name: 'Anker', slug: 'anker', status: BrandStatus.SYSTEM },
    { name: 'Huawei', slug: 'huawei', status: BrandStatus.SYSTEM }, // Added as requested
    { name: 'Nothing', slug: 'nothing', status: BrandStatus.SYSTEM },
    { name: 'OnePlus', slug: 'oneplus', status: BrandStatus.SYSTEM },
  ],
...
async function seedPopularEarbuds() {
  try {
    ...
    console.log(`\n📋 Included brands:`);
    popularEarbudsData.brands.forEach(brand => 
